...
import { onRequestPatch as __api_comments_js_onRequestPatch } from "/Users/tyler/Projects/Code/eric-wisnewski/functions/api/comments.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "PATCH",
      middlewares: [],
      modules: [__api_comments_js_onRequestPatch],
    },
  {
      routePath: "/api/comments",
      mountPath: "/api",
