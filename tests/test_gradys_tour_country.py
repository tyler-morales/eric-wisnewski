...
class CountrySourceTests(unittest.TestCase):
    ...
    def test_templates_put_globe_on_index_and_chip_on_posts_success(self) -> None:
        ...
        self.assertIn("Drag sideways to turn the globe.", nav)
        self.assertIn("Swipe up or down to scroll.", nav)
        self.assertIn("Hold, then drag, to tilt.", nav)
...
class CountryBuildTests(unittest.TestCase):
    ...
    def test_index_globe_filters_and_post_chip_navigates_success(self) -> None:
        ...
        self.assertIn("Drag sideways to turn the globe.", self.tour)
        self.assertIn("Swipe up or down to scroll.", self.tour)
